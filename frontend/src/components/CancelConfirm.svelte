...
<div class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-49 md:inset-0 h-full md:h-full justify-center items-center flex bg-black bg-opacity-50"
     role="dialog">
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 ">Are you sure you want to cancel your
                    application?</h3>
                <button type="button"
                        ...
                        on:click|preventDefault={cancelApplication}>
                    Yes, I'm sure
                </button>
                <button type="button"
